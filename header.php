			...
			<div id="top-header">
				<div class="container">
					<ul class="header-links pull-left">
						<li><a href="#"><i class="fa fa-phone"></i> +91-6767676767</a></li>
						<li><a href="#"><i class="fa fa-envelope-o"></i> shoppers123@gmail.com</a></li>
					...
					<ul class="header-links pull-right">
						...
						<li><?php
							 ...
							 if(isset($_SESSION["uid"])){
								$uid = mysqli_real_escape_string($con, $_SESSION["uid"]); // Sanitize and escape the user ID
								...
								echo '
								<div class="dropdownn">
									<a href="#" class="dropdownn" data-toggle="modal" data-target="#myModal"><i class="fa fa-user-o"></i> HI ' . $value . '</a>
